...
quis lacus at, gravida maximus elit. Duis tristique, nisl nullam.
    ...
    b.iter(|| {
        format!("{}", webescape::html(string_long));
        format!("{}", webescape::html(string_short));
        format!("{}", webescape::html(empty));
        format!("{}", webescape::html(no_escape));
        format!("{}", webescape::html(no_escape_long));
    });
}
